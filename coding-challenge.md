...
To get started, please create a new public repo where you can commit your cod. Remember to make regular commits se we can see how you break down your functionality! Once you have finished the challenge or you have ran out of time, please send us a link to your repo.
...
- You need to write the Front-End as well as the Back-End code.
...
- For your Front-End, please use a component based framework such as React, Angular, Vue or even better Web Components!
- For the Back-End, please use Java with Spring Boot to create your API.
- Each phase below will require you to write Front-end code as well as Back-end code.
- The data provided needs to be stored in a NoSql Database.
